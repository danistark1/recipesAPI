    ...
    public static function setSchema() {
        if (empty(self::$schema)) {
            self::$schema = new Assert\Collection([
                ...
                'prep_time' =>  new Assert\Optional([new Assert\Length(['min' => 3])]),
                'cooking_time' => new Assert\Optional([new Assert\Length(['min' => 3])]),
                ...
                'added_by' => new Assert\Optional([new Assert\Length(['min' => 3])]),
