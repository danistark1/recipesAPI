 ...
 */
final class Version20210402212856 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE recipesEntity (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, prep_time TIME DEFAULT NULL, cooking_time TIME DEFAULT NULL, servings INT DEFAULT NULL, category VARCHAR(100) NOT NULL, directions LONGTEXT NOT NULL, insert_date_time DATETIME NOT NULL, favourites INT NOT NULL, added_by VARCHAR(100) DEFAULT NULL, calories VARCHAR(100) DEFAULT NULL, cuisine VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
