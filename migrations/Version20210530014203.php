 ...
 */
final class Version20210530014203 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE recipesMedia (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(50) NOT NULL, path VARCHAR(100) NOT NULL, type VARCHAR(30) NOT NULL, size INT NOT NULL, insertDateTime DATETIME NOT NULL, imageWidth INT DEFAULT NULL, imageHeight INT DEFAULT NULL, insertUserID INT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
